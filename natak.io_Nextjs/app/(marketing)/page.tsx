    ...
    <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
      ...
      <div className="relative">
        ...
        <div className="space-y-40">
          {[
            { step: "01", title: "IMPORT CONTENT", desc: "Connect your storage and let our system automatically organize your media and metadata.", icon: <Database size={24} /> },
            { step: "02", title: "SMART PROCESSING", desc: "Our powerful cloud network handles upscaling, tagging, and formatting instantly.", icon: <Cpu size={24} /> },
            { step: "03", title: "SCALE UP", desc: "Your final assets are ready for distribution across all your platforms with one click.", icon: <Globe size={24} /> }
          ].map((item, i) => (
            <motion.div
              key={i}
...
const CTASection = ({ isSystemActive }: { isSystemActive: boolean }) => (
  <section className="py-60 px-6 text-center relative overflow-hidden bg-black">
    ...
    <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} className="max-w-4xl mx-auto relative z-10">
      <h2 className="text-6xl md:text-9xl font-black uppercase tracking-tighter italic leading-[0.8] mb-12">Ready to <br /> <span className="text-lime">Automate?</span></h2>
      <p className="text-zinc-500 text-lg md:text-xl font-medium uppercase tracking-tight mb-16 max-w-2xl mx-auto">Join the creators building high-performance visual empires with NATAK.</p>
